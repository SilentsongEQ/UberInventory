...
-- Strings used within UberInventory
    ...
    UBI_OPTION_GBTRACK_TIP = "If checked, guildbank data for the current toon will be saved.|nIf unchecked, data already stored will not be removed but no new items will be tracked.|nUse the command /ubi remguild <guild name> to delete unwanted data.";
